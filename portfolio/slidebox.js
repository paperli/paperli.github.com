...
function initial_slides(index){
	...
	if(index == counts-1){
		dot.children('a').css('background-image','url(images/indicator_normal2_t.png)');
		dot.children('a').hover(function(){ $(this).css('background-image','url(images/indicator_over2_t.png)');}, function(){ $(this).css('background-image','url(images/indicator_normal2_t.png)');});
	}
	
	if (index == at){
		if(index == counts-1){
			dot.children('a').css('background-image','url(images/indicator_active2_t.png)');
			dot.children('a').hover(function(){ $(this).css('background-image','url(images/indicator_over2_t.png)');}, function(){ $(this).css('background-image','url(images/indicator_active2_t.png)');});
		} else {
...
function slideTo(num){
	...
	$('.indicator').children('.dot').each(function(index){
												   if (index == at){
												   	if (index == counts-1){
												   		$(this).children('a').css('background-image','url(images/indicator_active2_t.png)');
													   $(this).children('a').hover(function(){ $(this).css('background-image','url(images/indicator_over2_t.png)');}, function(){ $(this).css('background-image','url(images/indicator_active2_t.png)');});
												   	} else {
												   	...
												   	if (index == counts-1){
												   		$(this).children('a').css('background-image','url(images/indicator_normal2_t.png)');
													   $(this).children('a').hover(function(){ $(this).css('background-image','url(images/indicator_over2_t.png)');}, function(){ $(this).css('background-image','url(images/indicator_normal2_t.png)');});
												   	} else {
